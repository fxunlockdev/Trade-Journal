...
const BOT_HANDLE = "@TradingJournalImagesBot";
...
export function TelegramLinkCard() {
  ...
  // Polled while a code is outstanding, so the card flips to "linked" on its
  // own when the message lands, without a "check again" button.
  useEffect(() => {
        ...
        {status?.linked ? (
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              . Add a date like <code className="rounded bg-muted/40 px-1">28 aug</code>{" "}
              for a past trade.
            </p>
            <Button
              type="button"
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              It lasts 15 minutes. This page updates by itself once the bot
              has it.
            </p>
          </div>
        ) : (
