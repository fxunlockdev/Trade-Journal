...
const tradeActionSchema = z.object({
  ...
  data: z.object({
    ...
    // Multi-TP (optional, additive). Up to 7 TPs — some signal groups use
    // that many (5-7 staggered exits is common in crypto/index signals).
    ...
    tp5_result: tpResultEnum.nullable().optional(),
    tp6_result: tpResultEnum.nullable().optional(),
    tp7_result: tpResultEnum.nullable().optional(),
